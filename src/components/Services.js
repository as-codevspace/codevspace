...
export default function Services() {
  return (
    <section id="services" class="flex justify-center items-center py-3 py-md-5 light-gray">
        ...
        <Container>
          ...
          <Row xs={1} sm={2} md={3} className="py-1 py-md-3">
            <Col className="px-3 py-3">
              <h1 className="text-md-center py-3 text-dark codevspace-h2">
                <p>
                  <span>Custom Software Development</span>
                </p>
              </h1>
              <p>
                <span className="codevspace-text">
